...
public class Rational {
    ...
    public Rational add(Rational other) {
        ...
        long comD = this.y * other.y;
        long num1 = this.x*other.y;
        long num2 = other.x*this.y;
        long sum = num1 + num2;
        return new Rational(sum, comD);
    }

    // Returns the product of this rational number and other.
    public Rational multiply(Rational other) {
        // Product of rationals a/b and c/d is the rational ac / bd.
        long numer = this.x* other.x;
    ...
    public boolean equals(Object other) {
        ...
        return ((this.x/this.y) == otherRational.x/otherRational.y);
