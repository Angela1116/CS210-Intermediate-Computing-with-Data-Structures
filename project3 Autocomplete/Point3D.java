...
public class Point3D implements Comparable<Point3D> {
    ...
    public double distance(Point3D other) {
        ...
        double sumOfsq = diffx*diffx + diffy*diffy + diffz*diffz;
    ...
    public int compareTo(Point3D other) {
        ...
        double thisDis = this.distance(origin);
        double otherDis = other.distance(origin);
        int answer = Double.compare(thisDis, otherDis);
        return answer;
    }
