...
public class Term implements Comparable<Term> {
    String query;  // instance variable data type String, query represent the word that people type

    long weight; // instance variable data type long, represent the term`s weight
    ...
    public static class PrefixOrder implements Comparator<Term> {
        int r;  // instance variable type int, r represent the length of prefix
